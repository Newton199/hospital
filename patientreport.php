...
<span>Events assigned to the table can be exceptionally useful for user interaction, however you must be aware that DataTables will add and remove rows from the DOM as they are needed (i.e. when paging only the visible elements are actually available in the DOM). As such, this can lead to the odd hiccup when working with events.</span> -->
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <ul class="nav nav-tabs md-tabs tabs-left b-none" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#billing" role="tab">Billing
                                                Report</a>
                                            <div class="slide"></div>
                                        </li>
                                        <li class="nav-item">
                                            ...
                                            <div class="table-responsive dt-responsive">
                                                <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>&nbsp;<?php echo date("d-M-Y", strtotime($rsappointment['appointmentdate'])); ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>Appointment Time</th>
                                                        <td>&nbsp;<?php echo date("h:i A", strtotime($rsappointment['appointmenttime'])); ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                 ...
                 $sql = "SELECT * FROM treatment_records LEFT JOIN treatment ON treatment_records.treatmentid=treatment.treatmentid 
                 WHERE treatment_records.patientid='$_GET[patientid]' AND 
                                                ...
                                                <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;<?php echo $rsbilling_records['billingdate']; ?>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;<?php echo $rsbilling_records['billingtime']; ?>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;Tk. <?php echo $rsbilling_records['discount']; ?>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;Tk.
                                                                <?php echo ($billamt + $taxamt)  - $rsbilling_records['discount']; ?>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                        ...
                        ?>
                                                ...
                                                <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="413">
                                                                <?php echo $rsbilling_records['billingdate']; ?></td>
                                                            <td width="413">Billing time&nbsp; </td>
                                                            <td width="413">
                                                                <?php echo $rsbilling_records['billingtime']; ?></td>
                                                        </tr>
                                  ...
                                  ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="413">&nbsp;Tk.
                                                                <?php echo $taxamt = 5 * ($billamt / 100); ?></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td rowspan="4" valign="top">
                                                                <?php echo $rsbilling_records['discountreason']; ?></td>
                                                            <th scope="col">
                                                                <div align="right">Discount &nbsp; </div>
                                                            </th>
                                                            <td>&nbsp;Tk. <?php echo $rsbilling_records['discount']; ?>
                        ...
                        ?>
                                ...
                                ?>
                                                            <tr>
                                                                ...
                                                                <td>&nbsp;Tk. <?php echo $rspayment['paidamount']; ?>
                                                                </td>
                                                            </tr>
                                                            <?php
                                }
