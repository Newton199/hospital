...
if(isset($_GET['editid']))
{
    $sql="SELECT * FROM treatment_records WHERE treatment_record_id='$_GET[editid]' ";
...
<li class="breadcrumb-item"><a href="#">Add Treatment Record</a>
</li>
</ul>
</div>
</div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="date" class="form-control" name="treatment_date" id="treatment_date"
                                    value="<?php if(isset($_GET['editid'])) { echo $rsedit['treatment_date']; } ?>" />
            <span class="messages"></span>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="time" class="form-control" name="treatment_time" id="treatment_time"
                                    value="<?php if(isset($_GET['editid'])) { echo $rsedit['treatment_time']; } ?>" />
            <span class="messages"></span>
        </div>
    </div>
